//
//  VisionAnalysisGameView.swift
//  optiquizz
//
//  Vue du quiz "Analyse de la vision"
//

import SwiftUI

struct VisionAnalysisGameView: View {
    ...
    var body: some View {
        ZStack {
            // Fond dégradé (couleur différente pour différencier de PDM)
            LinearGradient(
    ...
    private func startGame() {
        ...
        questions = VisionAnalysisQuizData.questions.shuffled().prefix(10).map { $0 }
